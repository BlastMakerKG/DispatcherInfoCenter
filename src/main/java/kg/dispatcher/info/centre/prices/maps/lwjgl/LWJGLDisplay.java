...
import kg.dispatcher.info.centre.prices.maps.lwjgl.objects.venichles.*;
import kg.dispatcher.info.centre.prices.maps.lwjgl.objects.*;
import org.lwjgl.input.Keyboard;
import org.lwjgl.input.Mouse;
import org.lwjgl.opengl.Display;
import kg.dispatcher.info.centre.prices.xmlFile.model.ReliefItems;
import kg.dispatcher.info.centre.prices.xmlFile.ParseXmlPoints;
...
//    }
    ...
    public Double[] getCoor(){
        return new Double[]{230.0d, 450.0d};
    }
